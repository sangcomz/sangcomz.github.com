...
[UNIDIRECTIONAL USER INTERFACE ARCHITECTURES](http://staltz.com/unidirectional-user-interface-architectures.html) 여기에 정리가 잘 되어있다. 여기에 있는 architecture를 하나씩 구현해보면...(?) 좋은 공부가 될것같다.
